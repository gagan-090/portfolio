      ...
      <div className="max-w-[1200px] mx-auto px-gutter h-20 flex justify-between items-center relative z-50">
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="hidden md:block bg-[#0A0A0A] text-white px-6 py-2.5 font-label-mono text-label-mono uppercase tracking-widest font-bold hover:bg-[#2563EB] transition-colors duration-200"
          >
            Hire Me
          </button>
          ...
          >
            <span 
              className={`w-6 h-0.5 bg-[#0A0A0A] transition-all duration-300 transform origin-center ${
          ...
          >
            <div className="flex flex-col p-6 gap-6">
              {navLinks.map((link, index) => (
                ...
                >
                  <NavLink 
                    ...
                    onClick={closeMenu}
                    className={({ isActive }) => 
                      `block font-headline-sm text-headline-sm font-semibold transition-colors duration-200 py-2 border-b border-neutral-100 ${
                        isActive 
                          ? 'text-primary' 
                          : 'text-on-surface-variant hover:text-primary'
                      }`
              ...
              <motion.button 
                ...
                className="w-full bg-[#0A0A0A] text-white py-3 font-label-mono text-label-mono uppercase tracking-widest font-bold hover:bg-[#2563EB] transition-colors duration-200 mt-2"
              >
                Hire Me
              </motion.button>
            </div>
